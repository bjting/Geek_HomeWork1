...
class ExportRequest(BaseModel):
    ...
    format: Literal["csv", "json", "excel"] = Field(..., description="Export format: csv, json, or excel")
    max_rows: int = Field(default=1000, ge=1, le=1000, description="Maximum rows to export (1-1000)")
